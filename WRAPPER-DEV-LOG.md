...
## 2025-10-06 (SimulStreamingライセンス注意喚起)
- 背景／スコープ：SimulStreaming バックエンドを商用利用する際のライセンス確認が明示されていなかった。
- 決定事項：
  - Backend 設定ダイアログにライセンス注意文を追加。
  - README に同旨の案内を追記。
- 根拠・検討メモ：
  - 商用利用時のライセンス遵守を促すため。
- 未解決事項：
...
## 2025-08-31
- 背景／スコープ：GUI 表示を英語に統一する要望。
- 決定事項：
  - GUI 内の日本語ラベル・警告・メッセージを英語化。
  - README に英語化方針を追記。
- 根拠・検討メモ：海外ユーザーにも分かりやすい UI を提供するため。
- 未解決事項：多言語切替機能の実装。
- 次アクション：ローカライズ機構の検討。
- リスク／課題：日本語 UI を期待していた既存ユーザーへの影響。
- 参照リンク：`wrapper/app/gui.py`, `README-FOR-WRAPPER.md`

## 2025-08-31
- 背景／スコープ：日本語環境へのローカライズと CUDA 検出表示の追加要望。
- 決定事項：
  - OS ロケールが日本語の場合にラベルやダイアログを日本語表示。
  - ライセンスボタン横に CUDA 検出状況アイコン（✅/❌）を設置。
- 根拠・検討メモ：日本語ユーザーの操作性向上と GPU 利用可否の即時確認のため。
- 未解決事項：一部動的メッセージの翻訳精度向上。
- 次アクション：他言語への拡張対応を検討。
- リスク／課題：翻訳漏れによる表示混在。
- 参照リンク：`wrapper/app/gui.py`, `README-FOR-WRAPPER.md`

## 2025-09-01 (FFmpeg�������݃G���[: GUI���R�[�_�[���̃t�H�[�}�b�g�s��v)
- �w�i�E�X�R�[�v�FGUI��Recorder�g�p���� FFmpeg "Connection lost" ���A�����������i�܂Ȃ����ہB
- ���莖���FREADME-FOR-WRAPPER.md �Ɍ���/�����𖾋L�i�g���u���V���[�e�B���O��ǉ��j�B
- �����E���������F
  - �㗬FFmpeg�� -i pipe:0 �ŃR���e�i������z��BWeb UI�� audio/webm�i����j�BGUI���R�[�_�[�͐�PCM16�𑗐M���������ʕs�\��FFmpeg�������I���B
  - �Q��: whisperlivekit/ffmpeg_manager.py:62, whisperlivekit/web/live_transcription.js:388, wrapper/app/gui.py:1943
- �����������FGUI���R�[�_�[�o�H�ł̓��͎w��ؑցi-f s16le -ac 1 -ar 16000 -i pipe:0�j�܂��� webm ���M���B
- ���A�N�V�����F���b�p�[���Ńt�H�[�}�b�g�����̎����Ă��������Aupstream����ςŉ����i�N������/���M�`���̐ؑցj�B
- ���X�N�E�ۑ�F�u���E�U�O��webm�G���R�[�h���s���ꍇ�̈ˑ����A���邢��FFmpeg�N�����[�h�̕���̕��G���B
- �Q�ƃ����N�FREADME-FOR-WRAPPER.md�i�{�߁j
